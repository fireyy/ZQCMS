...
<div class="content">
	...
	<div class="article">
		...
		<div class="pr-agreement">
				<p>版权所有 (c)2003-2011，ZQCMS.com 保留所有权利。 </p>
			...
			<h3>二、协议规定的约束和限制 </h3>
				<p>1、未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目的或实现盈利的网站）。购买商业授权请登陆   <a href="http://bbs.ZQCMS.com" target="_blank">bbs.ZQCMS.com</a> 了解最新说明。</p>
				<p>2、未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</p>
				<p>3、不管你的网站是否整体使用 ZQCMS ，还是部份栏目使用 ZQCMS，在你使用了 ZQCMS 的网站主页上必须加上 ZQCMS   官方网址(<a href="http://www.ZQCMS.com" target="_blank">www.ZQCMS.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 ZQCMS   的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
